...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="edimenu.css?d={random number/string}">
	</head>
	...
	<div id=title>Edit / Remove Menu Item</div>
	...
	<?php		
		if(isset($_POST['delete'])) {
			...
			$add = mysqli_query($conn,"SELECT * FROM menuitems");
			if($add->num_rows>0){
	...
	<section>
		...
		<div id="menulist">
			...
			$sql= "SELECT ITEMNO,name,price,category,discount,img from menuitems ";
			$result =$conn ->query($sql);
